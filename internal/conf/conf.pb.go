...
type Server struct {
	...
	Tcp           *Server_TCP            `protobuf:"bytes,6,opt,name=tcp,proto3" json:"tcp,omitempty"`
	Udp           *Server_UDP            `protobuf:"bytes,7,opt,name=udp,proto3" json:"udp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server_UDP) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\"\xe6\x06\n" +
	"\x06Server\x12+\n" +
	...
	"\x04mqtt\x18\x05 \x01(\v2\x17.kratos.api.Server.MQTTR\x04mqtt\x12(\n" +
	"\x03tcp\x18\x06 \x01(\v2\x16.kratos.api.Server.TCPR\x03tcp\x12(\n" +
	"\x03udp\x18\a \x01(\v2\x16.kratos.api.Server.UDPR\x03udp\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x1aN\n" +
	"\x03UDP\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xdd\x02\n" +
	"\x04Data\x125\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Server_TCP)(nil),          // 8: kratos.api.Server.TCP
	(*Server_UDP)(nil),          // 9: kratos.api.Server.UDP
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Server.tcp:type_name -> kratos.api.Server.TCP
	9,  // 8: kratos.api.Server.udp:type_name -> kratos.api.Server.UDP
	...
	12, // 13: kratos.api.Server.Websocket.timeout:type_name -> google.protobuf.Duration
	12, // 14: kratos.api.Server.TCP.timeout:type_name -> google.protobuf.Duration
	12, // 15: kratos.api.Server.UDP.timeout:type_name -> google.protobuf.Duration
