...
require (
	...
	github.com/go-kratos/kratos/contrib/registry/kubernetes/v2 v2.0.0-20260228034312-fe9258d38fd4
	...
	github.com/tx7do/kratos-transport/transport/mqtt v1.2.18
	github.com/tx7do/kratos-transport/transport/rabbitmq v1.2.18
	github.com/tx7do/kratos-transport/transport/websocket v1.2.18
